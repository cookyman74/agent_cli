...
1.  **Global context file:**
    - **Location:** `~/.didim/AGENTS.md` (in your user home directory).
    - **Scope:** Provides default instructions for all your projects.

2.  **Project root and ancestor context files:**
    - **Location:** The CLI searches for a `AGENTS.md` file in your current
...
3.  **Sub-directory context files:**
    - **Location:** The CLI also scans for `AGENTS.md` files in subdirectories
...
- **`/memory refresh`**: Forces a re-scan and reload of all `AGENTS.md` files
  from all configured locations.
- **`/memory add <text>`**: Appends your text to your global
  `~/.didim/AGENTS.md` file. This lets you add persistent memories on the fly.
