...
describe('IdeClient', () => {
  ...
  beforeEach(async () => {
    ...
    process.env['DIDIM_CLI_IDE_WORKSPACE_PATH'] = '/test/workspace';
    delete process.env['DIDIM_CLI_IDE_SERVER_PORT'];
    delete process.env['DIDIM_CLI_IDE_SERVER_STDIO_COMMAND'];
    delete process.env['DIDIM_CLI_IDE_SERVER_STDIO_ARGS'];
    delete process.env['DIDIM_CLI_IDE_AUTH_TOKEN'];
  ...
  describe('connect', () => {
    ...
    it('should connect using HTTP when port is provided in environment variables', async () => {
      process.env['DIDIM_CLI_IDE_SERVER_PORT'] = '9090';
    ...
    it('should connect using stdio when stdio config is in environment variables', async () => {
      process.env['DIDIM_CLI_IDE_SERVER_STDIO_COMMAND'] = 'env-cmd';
      process.env['DIDIM_CLI_IDE_SERVER_STDIO_ARGS'] = '["--bar"]';
  ...
  describe('getConnectionConfigFromFile', () => {
    ...
    it('should prioritize the config matching the port from the environment variable', async () => {
      process.env['DIDIM_CLI_IDE_SERVER_PORT'] = '2222';
      const config1 = { port: '1111', workspacePath: '/test/workspace' };
      const config2 = { port: '2222', workspacePath: '/test/workspace2' };
    ...
    it('should match env port string to a number port in the config', async () => {
      process.env['DIDIM_CLI_IDE_SERVER_PORT'] = '3333';
      const config1 = { port: 1111, workspacePath: '/test/workspace' };
  ...
  describe('authentication', () => {
    ...
    it('should connect with an auth token from environment variable if config file is missing', async () => {
      process.env['DIDIM_CLI_IDE_SERVER_PORT'] = '9090';
      process.env['DIDIM_CLI_IDE_AUTH_TOKEN'] = 'env-auth-token';
