...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .didimignore files in context (/settings)…',
  ...
  'Use Task tools (task_create, task_list) for structured task management…',
  ...
  'Reload instructional context from AGENTS.md files with /memory refresh…',
