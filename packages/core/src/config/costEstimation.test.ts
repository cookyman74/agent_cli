...
import { estimateCost, formatCostString, MODEL_PRICING } from './costEstimation.js';
...
describe('costEstimation (Phase 4 F4-2)', () => {
  describe('MODEL_PRICING', () => {
    ...
    it('should contain pricing for known claude models', () => {
      ...
      expect(MODEL_PRICING['claude']['claude-sonnet-4-5-20250929']).toBeDefined();
      expect(MODEL_PRICING['claude']['claude-haiku-4-5-20251001']).toBeDefined();
    });
  ...
  describe('estimateCost', () => {
    ...
    it('should aggregate costs by provider for multi-provider scenario', () => {
      ...
      //   subtotal = 2.965
      const geminiCost = 0.45 + 0.015 + 2.50;
